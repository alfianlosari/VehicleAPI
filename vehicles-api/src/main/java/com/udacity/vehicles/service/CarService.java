...
public class CarService {
    ...
    public CarService(CarRepository repository, ModelMapper modelMapper, @Qualifier("maps") WebClient webClientMaps, @Qualifier("pricing") WebClient webClientPricing) {
